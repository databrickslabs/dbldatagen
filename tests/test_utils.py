...
class TestUtils:
        ...
        [
            (
                ...
                [
                    ...
                    ['city_id', 'city_pop'],
                    ['id'],
                    ['city_id', 'city_pop', 'city_id', 'city_pop'],
                    ['id'],
                ],
            ),
            (
    ...
    @pytest.mark.parametrize(
        "path,jsonData, defaultValue, expectedValue",
        [
