...
class TestSerialization:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                [
                    {"colName": "col1", "colType": "string", "template": r"\w.\w@\w.com|\w@\w.co.u\k"},
                    {
                        "colName": "col2",
                        "colType": "string",
                        "text": {"kind": "TemplateGenerator", "template": "ddd-ddd-dddd"},
                    },
                    {
                        "colName": "col3",
                        "colType": "string",
            ...
            (
                ...
                [
                    ...
                    },
                    {
                        "colName": "col2",
                        "colType": "double",
                        "dataRange": {"kind": "NRange", "minValue": 0.0, "maxValue": 10.0, "step": 0.1},
                    },
                ],
            ),
            (
            ...
            (
                ...
                [  # Testing serialization error with PyfuncText
                    {"colName": "col1", "colType": "string", "text": {"kind": "PyfuncText", "fn": "lambda x: x.trim()"}}
                ],
            ),
            (
                pytest.raises(ValueError),
                [  # Testing serialization error with a bad "kind"
                    {
                        "colName": "col1",
                        "colType": "string",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                pytest.raises(ValueError),
                [  # Testing an invalid "relation" value
                    {"kind": "LiteralRange", "columns": ["col1"], "lowValue": -1000, "highValue": 1000, "strict": True},
                    {"kind": "PositiveValues", "columns": ["col1", "col2"], "strict": True},
                    {"kind": "SqlExpr", "expr": "col1 > 0"},
                    {"kind": "LiteralRelation", "columns": ["col2"], "relation": "+", "value": "0"},
    ...
    def test_constraint_definitions_from_dict(self, constraints, expectation):
        with expectation:
            ...
            gen_from_dicts = (
                dg.DataGenerator(rows=100, partitions=1)
