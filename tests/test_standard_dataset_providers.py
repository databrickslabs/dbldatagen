...
class TestStandardDatasetProviders:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "basic/geometries",
                {"rows": -1, "partitions": -1, "geometryType": "multipolygon"},
        ...
        [
            (
                "basic/process_historian",
                {
                    ...
                    "endTimestamp": "2020-04-01 00:00:00",
                },
            ),
            (
                "basic/process_historian",
            ...
            (
                "basic/process_historian",
                {
                    ...
                    "numPlants": 10,
                    "numTags": 5,
                    "startTimestamp": "2020-04-01 00:00:00",
                    "endTimestamp": "2020-01-01 00:00:00",
                },
            ),
            (
                "basic/process_historian",
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "basic/stock_ticker",
                {"rows": 50, "partitions": 4, "numSymbols": 5, "startDate": "2024-01-01"},
                does_not_raise(),
            ),
            (
                "basic/stock_ticker",
                {"rows": 100, "partitions": -1, "numSymbols": 5, "startDate": "2024-01-01"},
                does_not_raise(),
            ),
            (
                "basic/stock_ticker",
                {"rows": -1, "partitions": 4, "numSymbols": 10, "startDate": "2024-01-01"},
                does_not_raise(),
            ),
            ("basic/stock_ticker", {}, does_not_raise()),
            (
                "basic/stock_ticker",
                {"rows": 5000, "partitions": -1, "numSymbols": 50, "startDate": "2024-01-01"},
                does_not_raise(),
            ),
            ("basic/stock_ticker", {"rows": 5000, "partitions": 4, "numSymbols": 50}, does_not_raise()),
            ("basic/stock_ticker", {"rows": 5000, "partitions": 4, "startDate": "2024-01-01"}, does_not_raise()),
            (
                "basic/stock_ticker",
                {"rows": 5000, "partitions": 4, "numSymbols": 100, "startDate": "2024-01-01"},
                does_not_raise(),
            ),
            (
                "basic/stock_ticker",
                {"rows": 1000, "partitions": -1, "numSymbols": 100, "startDate": "2025-01-01"},
                does_not_raise(),
            ),
            (
                "basic/stock_ticker",
                {"rows": 1000, "partitions": -1, "numSymbols": 10, "startDate": "2020-01-01"},
                does_not_raise(),
            ),
            (
                "basic/stock_ticker",
                {"rows": 50, "partitions": 2, "numSymbols": 0, "startDate": "2020-06-04"},
                pytest.raises(ValueError),
            ),
            ("basic/stock_ticker", {"rows": 500, "numSymbols": 12, "startDate": "2025-06-04"}, does_not_raise()),
            (
                "basic/stock_ticker",
                {"rows": 10, "partitions": 1, "numSymbols": -1, "startDate": "2009-01-02"},
                pytest.raises(ValueError),
            ),
            ("basic/stock_ticker", {"partitions": 2, "numSymbols": 20, "startDate": "2021-01-01"}, does_not_raise()),
            ("basic/stock_ticker", {"rows": 50, "partitions": 2, "numSymbols": 2}, does_not_raise()),
        ],
    )
    def test_basic_stock_ticker_retrieval(self, providerName, providerOptions, expectation):
        with expectation:
            ...
            if "startDate" in providerOptions:
                assert df.selectExpr("min(post_date) as min_post_date").collect()[0].asDict()[
                    "min_post_date"
                ] == date.fromisoformat(providerOptions.get("startDate"))
        ...
        [
            ...
            (
                "basic/telematics",
                {
                    ...
                    "random": False,
                    "numDevices": 50,
                    "startTimestamp": "2020-06-01 00:00:00",
                    "endTimestamp": "2020-04-01 00:00:00",
                    "minLat": 40.0,
                    "maxLat": 43.0,
                    "minLon": -93.0,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "benchmark/groupby",
                {"rows": 1000, "partitions": -1, "random": True, "groups": 5000, "percentNulls": 0.5},
            ),
            ...
            (
                "benchmark/groupby",
                {"rows": -1, "partitions": -1, "random": False, "groups": -50, "percentNulls": -12.1},
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {"table": "catalog_items", "numCatalogItems": -1, "dummyValues": 5},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "catalog_items", "numCatalogItems": 100, "numCustomers": 1000},
                does_not_raise(),
            ),
            ...
            (
                "multi_table/sales_order",
                {"table": "base_orders", "numOrders": -1, "numCustomers": -1, "startDate": None, "endDate": None},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_orders", "numOrders": 1000, "numCustomers": 10, "dummyValues": 2},
                does_not_raise(),
            ),
            ("multi_table/sales_order", {"table": "base_order_line_items", "rows": -1}, does_not_raise()),
            (
                "multi_table/sales_order",
                {"table": "base_order_line_items", "rows": -1, "partitions": -1},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_order_line_items", "numOrders": 1000, "dummyValues": 5},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_order_line_items", "numOrders": -1, "numCatalogItems": -1, "lineItemsPerOrder": -1},
                does_not_raise(),
            ),
            ("multi_table/sales_order", {"table": "base_order_shipments", "rows": -1}, does_not_raise()),
            (
                "multi_table/sales_order",
                {"table": "base_order_shipments", "rows": -1, "partitions": -1},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_order_shipments", "numOrders": 1000, "numCarriers": 10},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_order_shipments", "numOrders": -1, "numCarriers": -1, "dummyValues": 2},
                does_not_raise(),
            ),
            ...
            (
                "multi_table/sales_order",
                {"table": "base_invoices", "numOrders": 1000, "numCustomers": 10},
                does_not_raise(),
            ),
            (
                "multi_table/sales_order",
                {"table": "base_invoices", "numOrders": -1, "dummyValues": 2},
                does_not_raise(),
            ),
    ...
    def test_full_multitable_sequence(self):
        ...
        dfInvoices = multiTableDS.getSummaryDataset(
            table="invoices", plans=dfPlans, customers=dfCustomers, deviceEvents=dfDeviceEvents
        )
