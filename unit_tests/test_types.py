...
class TestTypes(unittest.TestCase):
    ...
    def test_decimal_min_and_max_values(self):
        ...
        min1, min2, min3, min4, min5 = results['max1'], results['min2'], results['min3'], results['min4'], results['min5']
        max1, max2, max3, max4, max5 = results['max1'], results['max2'], results['max3'], results['max4'], results['max5']
