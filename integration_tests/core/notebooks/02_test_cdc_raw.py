...
from dbldatagen.core.spec.schema import LogNormal

# COMMAND ----------

CATALOG = dbutils.widgets.get("catalog")
SCHEMA = "datagen_demo"
PREFIX = "dbldatagen_core_"
...
for table_name in EXPECTED_ROWS:
    ...
    batch_counts = {r["_batch_id"]: r["count"] for r in full_df.groupBy("_batch_id").count().collect()}
