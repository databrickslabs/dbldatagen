...
for table_name in EXPECTED_ROWS:
    ...
    summary_rows.append((
        TEST_NAME, table_name, "row_count_match", count1, EXPECTED_ROWS[table_name],
        passed_count,
    ...
    summary_rows.append((
        TEST_NAME, table_name, "exact_match", count1, EXPECTED_ROWS[table_name],
        passed_exact,
        json.dumps({
    ...
    summary_rows.append((
        TEST_NAME, table_name, "pk_determinism", count1, EXPECTED_ROWS[table_name],
        passed_pk,
        json.dumps({
            "pk_col": pk_col,
    ...
    print(f"  {table_name}: counts={count1}/{count2}, "
          f"exact_match={passed_exact}, pk_determinism={passed_pk}")
