...
@dataset_definition(name="basic/geometries", summary="Geometry WKT dataset", autoRegister=True, supportsStreaming=True)
    ...
    def getTableGenerator(
        ...
        **options: dict[str, Any],
        ...
        df_spec = dg.DataGenerator(
            ...
            "location_id",
            "long",
            minValue=self.MIN_LOCATION_ID,
            maxValue=self.MAX_LOCATION_ID,
            uniqueValues=rows,
        ...
        if geometryType == "point":
            ...
            df_spec = df_spec.withColumn("wkt", "string", expr=concatPairsExpr)
